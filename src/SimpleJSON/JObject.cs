...
public class JObject
{
	...
	public object RawValue => Kind switch
	{
		JObjectKind.Object => ObjectValue, 
		JObjectKind.Array => FlattenArray(), 
		JObjectKind.String => StringValue, 
		JObjectKind.Number => DoubleValue, 
		JObjectKind.Boolean => BooleanValue, 
		JObjectKind.Null => null, 
		_ => null, 
	};
	...
	private void MakeInteger(bool isNegative, ulong integerPart)
	{
		...
		if (!IsNegative)
		{
			...
			if (ULongValue <= int.MaxValue && ULongValue >= 0)
			{
	...
	public override string ToString()
	{
		return Kind switch
		{
			JObjectKind.Object => "JObject:Object", 
			JObjectKind.Array => "JObject:Array", 
			JObjectKind.String => StringValue, 
			JObjectKind.Number => DoubleValue.ToString(), 
			JObjectKind.Boolean => BooleanValue.ToString(), 
			JObjectKind.Null => "null", 
			_ => "JObject:unknown", 
		};
	}
